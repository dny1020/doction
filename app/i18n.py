...
_EN: dict[str, str] = {
    ...
    "graph": "Graph",
    "notes_desc": "Quick captures waiting to be filed. Move one under a page to file it.",
    ...
    "system_license": "Licence and source",
    "system_license_desc": "This instance runs free software. You are entitled to its source.",
    "license": "Licence",
...
_ES: dict[str, str] = {
    ...
    "graph": "Grafo",
    "notes_desc": "Capturas rápidas sin archivar. Mueve una bajo una página para archivarla.",
    ...
    "system_license": "Licencia y fuente",
    "system_license_desc": "Esta instancia corre software libre. Tienes derecho a su código.",
    "license": "Licencia",
